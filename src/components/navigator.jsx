...
class Navigator extends React.Component {
    ...
    handleLogoutClick = () => {
        ...
        request({
            ...
            successCallback: (res) => {
                // Display snackbar
                emitter.emit('showSnackbar', 'success', `User '${res.user}' logged out successfully.`);
                    ...
                    <Toolbar>
                        ...
                        <div style={styles.flexContainer}>
                            ...
                            <Tooltip title="GitHub Repository" aria-label="GitHub Repository">
                                <IconButton className="icon-container" href="https://github.com/yeliudev/geoviewer" aria-label="Github" color="inherit">
